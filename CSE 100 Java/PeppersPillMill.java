...
class PeppersPillMill {
    public static void main(String[] args) {
        ...
        try {
            ...
            writer.append(trialGroup1.getFileName() + ": " + trialGroup1.getAverage() + " "
                    + decimalFormat.format(trialGroup1.getStandardDeviation()) + "\n");

            writer.append(trialGroup2.getFileName() + ": " + trialGroup2.getAverage() + " "
                    + decimalFormat.format(trialGroup2.getStandardDeviation()) + "\n");

            writer.append(trialGroup3.getFileName() + ": " + trialGroup3.getAverage() + " "
                    + decimalFormat.format(trialGroup3.getStandardDeviation()) + "\n");
